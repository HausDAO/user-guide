...
Firstly, visit the [Admin App](https://admin.daohaus.club/summon). Here, you'll need to connect your wallet to the desired blockchain network.
...
Adding a Sponsor Threshold of 1 requires a member to sponsor proposals submitted by non-members. This is generally a good practice. Proposals submitted by members with more voting tokens than the threshold are auto-sponsored.
